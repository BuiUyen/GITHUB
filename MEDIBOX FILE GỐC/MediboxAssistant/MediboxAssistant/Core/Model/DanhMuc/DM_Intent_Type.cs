...
namespace Medibox.Model
{
    ...
    {
        public const int KHONG_HIEU = 0;
        public const int THOI_GIAN = 1;
        public const int NGAY_THANG = 2;
        public const int THOI_TIET = 3;
        public const int KE_CHUYEN = 4;
        public const int LINH_TINH = 5;
        public const int TIN_TUC = 6;
        public const int HOME_CONTROL = 7;
        public const int WIKI = 8;
        ...
        public static IList<DM_Intent_Type> GetDefaultList(int include_deactive)
        {
            ...
            _DefaultList.Add(new DM_Intent_Type(KHONG_HIEU, "Không hiểu".Translate(), 1));
            ...
            _DefaultList.Add(new DM_Intent_Type(WIKI, "Tra cứu thông tin wiki hoặc google".Translate(), 1));
