...
namespace Medibox
{
    public partial class FormViewDevice : FormBase
    {
        private const String TAG = "FormViewDevice";
        //Private
        ...
        {
            using (FormEditDevice form = new FormEditDevice(null, mListDevice))
            {
                if (form.ShowDialog() == System.Windows.Forms.DialogResult.OK)
                {
                    DoRefresh();
