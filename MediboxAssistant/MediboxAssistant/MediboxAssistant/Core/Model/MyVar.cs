...
namespace Medibox.Model
{
    public static class MyVar
    {
        ...
        //Data
        public static IList<Device> mListDevice = new List<Device>();
        public static IList<DM_Intent_Type> mListDM_Intent_Type = new List<DM_Intent_Type>();
        public static IList<DM_Entity_Type> mListDM_Entity_Type = new List<DM_Entity_Type>();

        public static IList<Home> mListHome = new List<Home>();
